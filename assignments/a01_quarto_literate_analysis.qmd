...
#For this assignment we will be looking at ocean data to help us practice how to work with Redfield Ratios. Redfield ratios are an important diagnotisc tool that allows marine biologists to measure ocean health. The ideal ratio is 16:1 and it that ratio changes it could tell us about pollution or the effects of climate change.
...
#For this project I had to install the package for readr for the next lines of code to run. I was able to see that the mean redfield ratio shows up as 6.21 which looks like it alligns with the 16:1 ratio.
